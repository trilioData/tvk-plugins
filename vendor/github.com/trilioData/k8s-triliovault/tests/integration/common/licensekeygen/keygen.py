...
def keymaker(organization, kube_uid, kubescope, server_id, license_edition, license_type_name,
    ...
    #license_text = ''.join([c for c in license_text_prefix] + [compressed_properties_text])
    ...
    key_path = os.path.join(project_root, 'docker-images/control-plane/license_keys/triliodata')
